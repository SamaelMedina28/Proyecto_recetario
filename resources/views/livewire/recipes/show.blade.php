<div class="max-w-4xl mx-auto px-4">
    ...
    <div class="text-center">
        <div class="inline-block bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 text-sm font-medium px-3 py-1 rounded-full mb-4">
    ...
    <div class="flex justify-end space-x-4">
        <flux:button variant="danger" wire:confirm="{{ __('Are you sure you want to delete this recipe?') }}" wire:click="delete({{ $recipe->id }})">
            {{ __('Delete') }}
        </flux:button>
